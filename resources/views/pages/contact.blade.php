...
class extends Component {
    ...
    #[Validate('required|string|in:general,incubation,coworking,partnership,media')]
    public string $inquiryType = 'general';
    ...
    public function submit(): void
    {
        ...
        // Mail::to(config('mail.from.address'))->send(new ContactFormSubmission($this->all()));

        $this->submitted = true;
        $this->reset(['name', 'email', 'company', 'inquiryType', 'message']);
    }
}; ?>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <x-ui.card class="p-6 lg:p-8">
                    ...
                    <form wire:submit="submit" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            @error('inquiryType') <span class="text-sm text-red-500">{{ $message }}</span> @enderror
                        </div>
                ...
                <div class="space-y-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@siliconile.com" class="text-muted-foreground hover:text-primary transition-colors">
                                        info@siliconile.com
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- Map Embed (Optional) -->
                    <div class="rounded-xl overflow-hidden border h-64 bg-muted flex items-center justify-center">
